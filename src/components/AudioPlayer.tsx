...
export default function AudioPlayer() {
    ...
    return (
        <>
            <div className="fixed bottom-16 md:bottom-0 left-0 right-0 h-[76px] md:h-24 bg-[#0a0f1e]/85 backdrop-blur-2xl border-t border-white/[0.05] z-50 flex items-center justify-between px-4 md:px-8 shadow-[0_-20px_40px_-20px_rgba(0,0,0,0.5)] light-mode:bg-white/90 light-mode:border-slate-200 transition-all duration-300">
                {/* Track Info */}
                <div
                ...
                <div className="absolute top-0 left-0 right-0 h-[3px] bg-slate-800/50 md:hidden light-mode:bg-slate-200">
                    <div
                        className="h-full bg-gradient-to-r from-brand-500 to-brand-300 rounded-r-full shadow-[0_0_8px_rgba(99,102,241,0.6)] transition-all duration-75"
                        style={{ width: `${(progress / (duration || 1)) * 100}%` }}
                    ></div>
                </div>
            </div>
